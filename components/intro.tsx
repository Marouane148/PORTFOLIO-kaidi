...
>
<span className="font-bold text-white">Salut, je suis <span className="text-white-500">Marouane</span> <span className="text-grey-500">Kaidi</span>.</span>
  ...
  Façonner l'avenir, une ligne de code à la fois. Avec une passion pour allier créativité et technologie, je crée des expériences intelligentes et fluides qui ont un réel impact.
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/marouane-kaidi/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
